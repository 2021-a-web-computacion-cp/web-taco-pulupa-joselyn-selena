...
let CasaController = class CasaController {
    ...
    async crearCasaFormulario(response, parametrosCuerpo) {
        ...
        casaDto.precio = +parametrosCuerpo.precio;
        casaDto.sector = parametrosCuerpo.sector;
        casaDto.disponibilidad = parametrosCuerpo.disponibilidad;
        try {
            ...
            if (errores.length > 0) {
                ...
                response.redirect('/casa/vista-crear' + '?mensaje= Se creo la casa en el sector ' + parametrosCuerpo.sector);
            }
        }
        catch (error) {
            console.error(error);
    ...
    async eliminarCasa(response, parametrosRuta) {
        try {
            ...
            response.redirect('casa/lista-casa' +
    ...
    async actualizarUno(response, parametrosRuta, parametrosCuerpo) {
        const casa = {
            ...
            precio: parseFloat(parametrosCuerpo.precio),
...
], CasaController.prototype, "inicio", null);
__decorate([
